...
const gridContainerVariants: GridContainerVariants = {
    hidden: { opacity: 0 },
    show: {
        opacity: 1,
        transition: {
...
const gridSquareVariants: GridSquareVariants = {
    hidden: { opacity: 0 },
    show: { opacity: 1 },
};

const svgIconVariants: SvgIconVariants = {
    hidden: {
        opacity: 0,
        pathLength: 0,
