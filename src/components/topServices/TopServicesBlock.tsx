...
function TopServicesBlock({ imageUrl, title, description }: TopServicesBlockProps) {
    return (
        <div className='flex flex-col w-full h-full'>
            ...
            <div className=' w-full h-[9.63%] mt-[13.55%] flex items-center'>
                <span className='text-[24px] leading-[32px] font-medium text-black'>{title}</span>

            </div>
            <div className=' h-[28.9%] mt-[2.52%] w-full'>
                <span className='text-[20px] leading-[32px] font-normal text-black'>{description}</span>
            </div>
