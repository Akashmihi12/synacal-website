            ...
            >
                <div className="w-[50%]">
                    ...
                    <div className="text-[20px] font-medium leading-[32px]  dark:text-white text-center">
                        ...
                        <span>Whether you need a MVP or extra bandwidth, every engagement starts with a discovery call. Connect with one of our specialists at a time that&apos;s convenient to you.</span>
                    </div>
