...
function DocumentAssistanceText({ title, content,dataContent }: DocumentAssistanceTextProps) {


    return (
        <div className='w-full h-full flex flex-col'>
            <div className='h-[144px] w-full '>
                <span className='text-[40px] font-semibold leading-[47.73px] text-black'>{title}</span>
            </div>
            ...
            <div className='h-[42px] w-full  mt-[68px]'>
                <div className=' w-full h-[42px] flex items-end gap-[4px]'>
                    ...
                    <div className=' h-[42px] w-[27.85%] flex items-center justify-center'>
                        <span className='text-[14px] font-semibold leading-[16.71px] text-black'>Get a demo</span>
                    </div>
                </div>
            </div>
