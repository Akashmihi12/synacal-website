      ...
      <div className="h-[42px] w-full  mt-[68px]">
        <div className=" w-full h-[42px] flex items-end gap-[4px]">
          <motion.div
            ...
            transition={{ duration: 6, ease: "easeOut", type: "spring", stiffness: 120 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.div
            ...
            <span className="text-[14px] font-semibold leading-[16.71px] text-black text-main-gradient hover:text-transparent hover:bg-clip-text 
                hover:bg-gradient-to-r hover:from-[#CF71ED] hover:to-[#3335E2] cursor-pointer">
              Get a demo
            </span>
          </motion.div>
